...
echo Html::tag('h1', $this->title, ['style' => 'font-size: 25px; color: #5cb85c']);
...
echo Html::tag('h2', $winText, ['style' => 'font-size: 20px; color: #5cb85c']);
...
echo ToolBarPanelContainer::widget([
        ...
        'buttonsRight' => [
            Html::a('Посмотреть тест', ['view', 'id' => $model->id], ['class' => 'btn btn-info btn-lg'])
        ],
