...
$this->title = "Тест № {$model->id} ученика {$model->user->name}";
$this->params['breadcrumbs'][] = ['label' => 'Тесты учеников', 'url' => ReturnUrl::getBackUrl()];
...
<div class="test-task-view">
    ...
    echo ToolBarPanelContainer::widget(
        [
            'buttonsLeft' => [
                CrudButton::cancelButton(Html::icon('arrow-left'), ['index']),
            ],
