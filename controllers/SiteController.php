    ...
    public function actionRequestPasswordReset()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->sendEmail()) {
                ...
                Yii::$app->session->setFlash('error', 'Извините, восстановление пароля не возможно. Скорее всего к вашему аккаунту не привязан почтовый ящик. Либо указан некорректный Email. Обратитесь к администратору.');
            }
        }
